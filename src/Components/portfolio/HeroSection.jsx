...
import { MapPin, Mail, Phone, Linkedin, Github, Twitter, Globe, Download } from 'lucide-react';
...
export default function HeroSection({ profile }) {
  ...
  const socialLinks = [
    ...
    { icon: Twitter, url: profile.social_links?.twitter, label: 'Twitter' },
          ...
          >
            ...
            >
              ...
              {profile.current_status && (
                <Badge variant="secondary" className="px-4 py-2 text-base bg-green-100 text-green-800 border-green-200">
                  {profile.current_status}
                </Badge>
              )}
              {profile.location && (
